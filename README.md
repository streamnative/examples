...
- [Produce and consume messages using KeyValue schema (inline)](schema/examples/produce-consume-kv-messages-inline.md)
- [Produce and consume messages using KeyValue schema (separated)](schema/examples/produce-consume-kv-messages-separated.md)
