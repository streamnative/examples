 ...
 * {@link org.apache.pulsar.client.api.Schema#KeyValue(Class, Class)}.
 */
public class KeyValueInlineSchemaConsumerExample {

    private static final Logger log = LoggerFactory.getLogger(KeyValueInlineSchemaConsumerExample.class);

    private static final String TOPIC = "keyvalue-inline-topic";
    ...
    public static void main(final String[] args) {
        ...
        try (PulsarClient client = PulsarClient.builder()
            ...
            try (Consumer<KeyValue<Integer, String>> consumer = client.newConsumer(kvSchema)
                 ...
                 .subscriptionName("test-kv-inline")
                 .subscribe()) {
